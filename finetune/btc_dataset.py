...
class BTCDataset(Dataset):
    ...
    Raises:
        ValueError: If [data_type](file:///Users/longquan/Documents/git_repository/myself/kronos/finetune/btc_dataset.py#L0-L0) is not 'train' or 'val'.
    """
